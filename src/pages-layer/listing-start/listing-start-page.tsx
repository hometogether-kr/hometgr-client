...
const FIGMA_TEMP_ILLUST_DRAFT = "/figma/illust-draft-b4228895.svg";
        ...
        <div className="flex w-full flex-col items-start gap-6 md:w-[1180px] md:gap-20">
          <header className="flex w-full flex-col items-start gap-3 md:w-[729px] md:gap-4">
            <div className="flex w-full flex-col items-start gap-2">
              <p className="text-sm leading-[1.4] font-semibold whitespace-nowrap text-primary-600 md:text-2xl md:tracking-[-0.24px]">
                Host
              </p>
              <h1 className="w-full text-[22px] leading-[1.4] font-semibold tracking-[-0.22px] text-grayscale-900 md:text-[40px] md:leading-[1.3] md:tracking-[-0.8px]">
                매물 등록을 단계별로 바로 시작할 수 있어요.
              </h1>
            </div>
            <p className="w-full text-sm leading-[1.5] font-medium text-grayscale-600 md:text-xl md:leading-[1.4] md:tracking-[-0.2px]">
