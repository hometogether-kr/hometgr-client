        ...
        <div className={styles.communityIntro}>
          ...
          <div className={styles.map}>
            <Image
              ...
              width={1658}
              height={877}
              sizes="(min-width:1280px) 1658px,1100px"
            />
          </div>
          <Image
            className={styles.mapConnector}
            src="/images/host-landing/map-connector.svg"
            alt=""
            width={131}
            height={79}
          />
          <p className={styles.houseCount}>
            <strong>55</strong>
            <span>
              <small>2026.09 기준</small>가구 관리 중
            </span>
          </p>
        </div>
        <div className={styles.reviews}>
          {reviews.map((review) => (
            <figure key={review.name} className={styles.review}>
