      ...
      <div className="flex flex-col gap-7">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1 whitespace-nowrap">
            <h2 className="text-2xl font-semibold leading-[1.4] tracking-[-0.24px] text-black">
              진행 단계
            </h2>
            <p className="text-base font-medium leading-[1.5] text-grayscale-600">
              {LISTING_STEPS.length}단계 중{" "}
              <span className="text-primary-600">{current}단계</span> 진행 중
            </p>
          </div>
          ...
          {LISTING_STEPS.map((label, index) => {
            ...
            return (
              <li key={label} className="flex items-start justify-center gap-2">
                ...
                <span className="flex-1 pb-3 text-sm font-semibold leading-[1.4]">
